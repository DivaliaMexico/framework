...
/*///////////////////////////////////////////////////////////////
 ...
 ///////////////////////////////////////////////////////////////*/
/**
 * EN: Divalia Framework - Micro framework base of kecik framework
 *
 * @author      Dony Wahyu Isp
 * @copyright   2016 Dony Wahyu Isp
 * @link        https://git.barrahome.org:3000/Divalia/framework.git
 * @license     MIT
 * @version     1.0.1
 * @package     Divalia
 *
...
$libraries_path = dirname(__DIR__."..")."/Libraries";
require_once "$libraries_path/MVC/MVC.php";
require_once "$libraries_path/Config/Config.php";
require_once "$libraries_path/Route/Route.php";
require_once "$libraries_path/Url/Url.php";
require_once "$libraries_path/Request/Request.php";
require_once "$libraries_path/Assets/Assets.php";
require_once "$libraries_path/php-ref/ref.php";
...
//                if (class_exists($ClsLibrary)) {
                    ...
                    if (isset($params['enable']) && $params['enable'] === TRUE) {
                        ...
                        if (!isset($params['config']) && !isset($params['params'])) {
                            ...
                            //** ID: Untuk Library/Pustaka dengan parameter Kelas Divalia
                            //** EN: For Library with parameter of Divalia CLass
                            ...
                            //** ID: Untuk Library/Pustaka tanpa parameter Kelas Divalia
                            //** EN: For Library without parameter of Divalia CLass
