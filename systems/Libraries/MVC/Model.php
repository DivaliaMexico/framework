    ...
    private static function __join($model, &$condition)
    {
        ...
        if (is_array($modeljoin::relational()) && count($modeljoin::relational()) > 0) {
            ...
            if (isset($relational[0]) && !is_array($relational[0])) {
                ...
                if (!isset($relational[2])) {
                    $relational[2] = $relational[1];
                }
                ...
                $condition['join'][] = array('left', $join_table, array($relational[1], $relational[2]));

                $modeljoin = $relational[0];
                self::__join($modeljoin, $condition);
            } else {
                while (list($id, $relation) = each($relational)) {
                    $model = '\Models\\' . $relation[0];
                    ...
                    $condition['join'][] = array('left', $join_table, array($relation[1], $relation[2]));
                }
        ...
        if (is_array(static::relational()) && count(static::relational()) > 0) {
            ...
            if (isset($relational[0]) && !is_array($relational[0])) {
                ...
                if (count($relational) == 1) {
                    $condition['join'][] = array('natural', $join_table);
                } elseif (count($relational) == 2) {
                    $condition['join'][] = array('left', $join_table, $relational[1]);
                ...
                while (list($id, $relation) = each($relational)) {
                    ...
                    if (count($relation) == 1) {
                        ...
                        $condition['join'][] = array('left', $join_table, $relation[1]);
