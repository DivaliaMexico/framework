...
class Database
{
    ...
    public function __construct()
    {
        ...
        $this->failOver = ($config->get('database.failover') != '' && is_array($config->get('database.failover'))) ? $config->get('database.failover') : array();
    }
