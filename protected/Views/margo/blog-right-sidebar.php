				...
				<div class="row blog-page">
					...
					<div class="col-md-9 blog-box">
						...
						<div class="blog-post image-post">
							<!-- Post Thumb -->
							<div class="post-head">
								<a class="lightbox" title="This is an image title" href="<?php echo $assets->images('blog-01.jpg') ?>">
						...
						<div class="blog-post gallery-post">
							...
							<div class="post-head">
								<div class="post-slider touch-slider">
									<div class="item">
										<a class="lightbox" title="This is an image title" href="<?php echo $assets->images('blog-02.jpg') ?>" data-lightbox-gallery="gallery1">
											<div class="thumb-overlay"><i class="fa fa-arrows-alt"></i></div>
											<img alt="" src="<?php echo $assets->images('blog-02.jpg') ?>">
										</a>
									</div>
									<div class="item">
										<a class="lightbox" title="This is an image title" href="<?php echo $assets->images('blog-03.jpg') ?>" data-lightbox-gallery="gallery1">
											<div class="thumb-overlay"><i class="fa fa-arrows-alt"></i></div>
											<img alt="" src="<?php echo $assets->images('blog-03.jpg') ?>">
										</a>
									</div>
									<div class="item">
										<a class="lightbox" title="This is an image title" href="<?php echo $assets->images('blog-04.jpg') ?>" data-lightbox-gallery="gallery1">
											<div class="thumb-overlay"><i class="fa fa-arrows-alt"></i></div>
