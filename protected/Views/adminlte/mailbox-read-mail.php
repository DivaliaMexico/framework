<?php $assets = $this->assets; $url = $this->url; ?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <div class="row">
            <div class="col-md-3">
              <a href="<?php $url->to('mailbox-compose') ?>?p=mailbox-compose" class="btn btn-primary btn-block margin-bottom">Compose</a>
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    <li><a href="<?php $url->to('mailbox') ?>?p=mailbox"><i class="fa fa-inbox"></i> Inbox <span class="label label-primary pull-right">12</span></a></li>
