...
$(function () {
    ...
    App.beforeSubmit = function() {
        ...
        data.report_id_old = $('#report_template_id_old').val();
        data.date = $('#date').val();
        data.department_id = $('#department_id').val();
        data.category = [];
        $('form').find('.box-category').each(function(idx, el) {
            data.category[idx] = {};
            data.category[idx].report_category_id = $(el).find('.box-header').find('#report_template_category_id').val();
            ...
            $(el).find('.box-group').each(function(idx2, el2) {
                ...
                data.category[idx].group[idx2].report_group_id = $(el2).find('.box-header').find('#report_template_group_id').val();
                ...
                $(el2).find('tbody').find('tr').each(function(idx3, el3) {
                    ...
                    data.category[idx].group[idx2].data[idx3].report_detail_id = $(el3).find('#report_template_detail_id').val();
    ...
    App.afterEdit = function(data) {
        ...
        $(data).each(function(idx, row) {
            $(row.ReportTemplateCategory).each(function(idx2, row2) {
                ...
                form_category.find('#report_template_category_id').val(row2.report_template_category_id)
                ...
                $(row2.ReportTemplateGroup).each(function(idx3, row3) {
                    ...
                    form_group.find('#report_template_group_id').val(row3.report_template_group_id);
                    ...
                    $(row3.ReportTemplateDetail).each(function(idx4, row4) {
                        if (idx4 == 0) {
                            form_group.find('#report_template_detail_id').val(row4.report_template_detail_id);
                            ...
                            var uom = form_group.find('#uom_id');
                        ...
                        var value = {
                            report_template_detail_id: row4.report_template_detail_id,
                            kpi: row4.kpi,
                            uom_id: row4.uom_id,
                            target: row4.target,
                            actual: row4.actual,
...
<tr>\
    ...
    <td>\
        <input type="hidden" name="report_template_detail_id[]" id="report_template_detail_id" value="0" /> \
...
<div class="box-group box box-primary box-solid" style = "padding-bottom: 0px;">\
    <div class="box-header">\
        <div class="form-group-sm">\
            <div class="col-sm-7">\
                <input type="hidden" name="report_template_group_id[]" id="report_template_group_id" value="0" /> \
                <input type="text" class="input-group-title form-control" style="height: 20px;" placeholder="Please insert the Title" />\
            </div>\
            <div class="col-sm-5">\
        ...
        <div class="box-tools pull-right">\
            ...
            <button type="button" class="btn_remove_group btn btn-box-tool">\
                <i class="fa fa-times"></i>\
            </button>\
        </div>\
    </div>\
    <div class="box-body" style="padding-bottom: 0px; margin-bottom: 0px; padding-top: 0px;">\
...
<div class="box-category box box-default box-solid" style="padding-bottom: 0px;">\
    <div class="box-header with-border" >\
        <div class="form-group-sm">\
            <div class="col-sm-7">\
                <input type="hidden" name="report_template_category_id[]" id="report_template_category_id" value="0" />\
        ...
        <div class="box-tools pull-right">\
            ...
            <button type="button" class="btn_remove_category btn btn-box-tool">\
                <i class="fa fa-times"></i>\
            </button>\
        </div>\
    </div>\
